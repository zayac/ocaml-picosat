...
(* OASIS_START *)
(* DO NOT EDIT (digest: a1314da682caa1efe54b95eb051c5eac) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_dlllib = [(OASISExpr.EBool true, ["-lpicosat"])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
                   },
                   {
                      lib_modules = ["Picosat"; "Logic"];
                      lib_pack = false;
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "OCaml API for PicoSAT";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "lib_test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "picologic"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamlbuild"
                        ];
                      bs_c_sources = [];
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "õTæÇYÃ¥Ò\018L¸×Ä\022\149ò";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
