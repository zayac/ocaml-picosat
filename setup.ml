...
(* OASIS_START *)
(* DO NOT EDIT (digest: 711e755e2234fbd6a96aeb6ec6201cdd) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_cclib = [(OASISExpr.EBool true, ["-lpicosat"])];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "lib_test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "picosat"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamlbuild"
                        ];
                      bs_c_sources = [];
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "3Ü4»%¸\024ø©Ï\022G1`\1558";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
